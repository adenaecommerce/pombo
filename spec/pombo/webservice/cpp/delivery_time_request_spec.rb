...
describe Pombo::Webservice::CPP::DeliveryTimeRequest do
  let(:package) do
  ...
  let(:request_hashes) { delivery_time_hash(package) }

  subject { Pombo::Webservice::CPP::DeliveryTimeRequest.new package }
